...
func printHelp() {
	...
	fmt.Println("Program for converting diacritics in unformatted text files in UTF-8 format.")
	fmt.Println()
        fmt.Println("    Use: ogonki [-help] [-lang flag] [file1.txt file2.txt ...]")
	fmt.Println("   Flag: [pl] [es] [de] [fr] [it] [cz] [hu] [se] [dk] [no] [fi]")
